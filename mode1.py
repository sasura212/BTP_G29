"""
-------------------------------------------------------------------------
Mode 1: Power and Irms Dataset Generator
-------------------------------------------------------------------------
Iterates through duty cycles (D0, D1, D2) to generate Power and Irms values
for Mode 1 operational constraints.
...
print('Generating dataset for Mode 1... This might take a moment.')
...
for D0 in duty_cycles:
    for D1 in duty_cycles:
        for D2 in duty_cycles:
            ...
            # --- Constraint Checking ---
            if (D1 < D0) and (D1 < (D0 + D2)) and ((D0 + D2) < 1):
...
if df.empty:
    ...
    # --- Save to CSV ---
    df.to_csv('mode1_dataset.csv', index=False)
    print('Dataset saved to mode1_dataset.csv')